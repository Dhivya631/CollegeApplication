...
<body>
    <br>
    <h2>Students Under ${courseName} Course</h2><br>
    <form method="post">
        ...
        <%
            ...
            try
            {
                String course = (String) request.getAttribute("courseName");
                String query="select semester.id as semid,semester.name,course.name as courseName,department.name as departmentName FROM course_semester join semester on semester.id=course_semester.semester_id join department on department.id=semester.department_id join course on course_semester.course_id=course.id group by courseName;";
        ...
        %>
        <br>
    <a href="/displayStudentsByCourse">Back</a>
</form>
</body>
</html>